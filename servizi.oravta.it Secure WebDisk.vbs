' servizi.oravta.it Secure WebDisk.vbs
'
...
' *************************************************************************
strURL = "\\servizi.oravta.it@SSL@2078\DavWWWRoot" ' This is the URL to the WebDAV share.
strDomainPort = "servizi.oravta.it@SSL@2078"
...
Sub ConfigureService()
   ...
   If colServiceList.Count = 1 Then
      ...
      Next
   Else
      WScript.Echo "Impossibile trovare il servizio “WebClient”."
   End If
End Sub
...
Sub CreateShorty ()
   ...
   MsgBox "Connessione a WebDisk in corso; l’operazione può richiedere un minuto.", 64, "Connessione a Web Disk"

   strName = "servizi.oravta.it Secure WebDisk"
